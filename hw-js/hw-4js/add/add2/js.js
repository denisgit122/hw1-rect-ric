...
<h3 class="h3">${arrElement.id} <div class="div"><div class="span">title</div> </div> ${arrElement.title}</h3>

<div class="userId">userId    -------<span class="span1"></span>${arrElement.userId}</div>
<div class="body">
<h5>${arrElement.body}</h5>
</div>
</div>`)
}
document.write(`</div>`)